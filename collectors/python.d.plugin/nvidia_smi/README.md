...
-   You must enable this plugin as its disabled by default due to minor performance issues, i.e. with `sudo /etc/netdata/edit-config python.d.conf` and uncommenting/setting `nvidia_smi: yes`.
